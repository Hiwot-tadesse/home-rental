    ...
    <Card className="w-full">
      ...
      <CardContent>
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
              ...
              {Array.from({ length: MAX_IMAGES }).map((_, index) => {
                ...
                if (imageUrl) {
                  return (
                    <div
                      key={index}
                      className="relative aspect-square rounded-lg overflow-hidden bg-muted border-2 border-transparent"
                    >
          ...
          {/* ------------------ PRICE + ROOMS + BATHROOMS + AREA (unchanged) ------------------ */}
